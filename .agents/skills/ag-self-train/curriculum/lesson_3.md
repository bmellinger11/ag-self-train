...
**What you just did:** You've just extended the Agent's system prompt! Now, any time it interacts with your Canvas project, it will naturally prefer hex codes over basic color names. 
